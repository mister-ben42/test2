	...
	public function testEqual($clsmt, $scUser, $i, $h, $sc)
		{
			...
			elseif($clsmt=='TotalMedia' and $scUser->getScofDayTM()==$sc){$j=$h;}
			elseif($clsmt=='MuQuizz' and $scUser->getScofDayMu()==$sc){$j=$h;}
			elseif($clsmt=='ArQuizz' and $scUser->getScofDayAr()==$sc){$j=$h;}
			elseif($clsmt=='FfQuizz' and $scUser->getScofDayFf()==$sc){$j=$h;}
			elseif($clsmt=='LxQuizz' and $scUser->getScofDayLx()==$sc){$j=$h;}
			else{$j=$i;}
			return $j;
		}
		public function majHighScore($clsmt, $scUser, $j)
		{
			if($clsmt=='KingMaster')
			{
				if($scUser->getHighClassKM()==NULL OR $j<$scUser->getHighClassKM()){
			...
			{
				if($scUser->getHighClassDayMq()==NULL OR $j<$scUser->getHighClassDayMq()){
			...
			{
				if($scUser->getHighClassDayTM()==NULL OR $j<$scUser->getHighClassDayTM()){
			...
			{
				if($scUser->getHighClassDayMu()==NULL OR $j<$scUser->getHighClassDayMu()){
			...
			{
				if($scUser->getHighClassDayAr()==NULL OR $j<$scUser->getHighClassDayAr()){
			...
			{
				if($scUser->getHighClassDayFf()==NULL OR $j<$scUser->getHighClassDayFf()){
			...
			{
				if($scUser->getHighClassDayLx()==NULL OR $j<$scUser->getHighClassDayLx()){
		...
		public function majMedailles($clsmt, $scUser, $j)
		{
			...
			if($clsmt=='KingMaster')
			{
				...
				elseif($j==4 or $j==5){$med->setKm4($med->getKm4()+1);}
				elseif($j>5 and $j<11){$med->setKm5($med->getKm5()+1);}
			}
			elseif($clsmt=='scofDayMq')
			{
				...
				elseif($j==4 or $j==5){$med->setMq4($med->getMq4()+1);}
				elseif($j>5 and $j<11){$med->setMq5($med->getMq5()+1);}
			}
			elseif($clsmt=='TotalMedia')
			{
				...
				elseif($j==4 or $j==5){$med->setTm4($med->getTm4()+1);}
				elseif($j>5 and $j<11){$med->setTm5($med->getTm5()+1);}
			}
			elseif($clsmt=='MuQuizz')
			{
				...
				elseif($j==4 or $j==5){$med->setMu4($med->getMu4()+1);}
				elseif($j>5 and $j<11){$med->setMu5($med->getMu5()+1);}
			}
			elseif($clsmt=='ArQuizz')
			{
				...
				elseif($j==4 or $j==5){$med->setAr4($med->getAr4()+1);}
				elseif($j>5 and $j<11){$med->setAr5($med->getAr5()+1);}
			}
			elseif($clsmt=='FfQuizz')
			{
				...
				elseif($j==4 or $j==5){$med->setFf4($med->getFf4()+1);}
				elseif($j>5 and $j<11){$med->setFf5($med->getFf5()+1);}
			}
			elseif($clsmt=='LxQuizz')
			{
				...
				elseif($j==4 or $j==5){$med->setLx4($med->getLx4()+1);}
