$(function () {	 
	...
	$('#bouton_jouer img').on('mouseover',(function(){		
		$('#bouton_jouer img').attr({src:'../bundles/GeneBundle/buttonjouervalide.png'});
		$('#bouton_jouer img').on('mouseout',(function(){		
		$('#bouton_jouer img').attr({src:'../bundles/GeneBundle/buttonjouer.png'});		
	}));
	}));
	...
	$('#accueil_jeu_boutonGo img').on('mouseover',(function(){
		$('#accueil_jeu_boutonGo img').attr({src:'../bundles/GeneBundle/LogoMqGo2.png'});
		$('#accueil_jeu_boutonGo img').on('mouseout',(function(){		
		$('#accueil_jeu_boutonGo img').attr({src:'../bundles/GeneBundle/LogoMqGo.png'});
		}));
	}));
});
});